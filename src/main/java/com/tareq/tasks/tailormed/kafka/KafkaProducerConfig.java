...
public class KafkaProducerConfig {
	...
	@Bean
	public ProducerFactory<String, HCSVRecord> csvRecordProducerFactory() {
	...
	@Bean
	public KafkaTemplate<String, HCSVRecord> csvRecordKafkaTemplate() {
		return new KafkaTemplate<>(csvRecordProducerFactory());
	}
